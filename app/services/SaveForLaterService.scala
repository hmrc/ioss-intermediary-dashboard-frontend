...
class SaveForLaterService @Inject()(
  ...
  def getAllClientSavedAnswers()(implicit hc: HeaderCarrier): Future[Seq[SavedUserAnswers]] = {
  ...
  def getAllSavedReturnsForClient(iossNumber: String)(implicit hc: HeaderCarrier): Future[Seq[SavedUserAnswers]] = {
