    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        contentAsString(result) mustEqual
          view(registrationWrapper.etmpDisplayRegistration.schemeDetails.businessEmailId, appConfig.changeYourRegistrationUrl)(request, messages(application)).toString
      }
    }
  }
}
